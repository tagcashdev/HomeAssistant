...
class ContentCardRoom extends LitElement {
    ...
    static get styles() {
        return css`
            :root, .ContentCardRoom .box .entities, .ContentCardRoom .box .entities_top_right{
                --mdc-icon-size: 16px;
            }

            ha-card.ContentCardRoom{
                position: relative;
                min-height: 48px;
                height: 100%;
                z-index: 0;
            ...
            ha-card.ContentCardRoom .box .card-header {
                padding: 5px 10px;
                font-weight: bold;
                font-size: 1.2em;
            }
            ha-card.ContentCardRoom .box .entities {
                white-space: nowrap;
                margin-top: -5px;
                margin-bottom: -18px;
                min-height: 10px;
            ...
            ha-card.ContentCardRoom .box .entities_bottom, ha-card.ContentCardRoom .box .entities_bottom_right {
                position: absolute;
                bottom: 5px;
                right: 10px;
            }

            ha-card.ContentCardRoom .box .entities_top_right {
                position: absolute;
                top: 5px;
                right: 10px;
            }

            ha-card.ContentCardRoom .box .wrapper {
                display: inline-block;
                vertical-align: middle;
                height: 24px;
                min-width: 24px;
            }
            ha-card.ContentCardRoom .box .wrapper .ha-icon-badge {
                --mdc-icon-size: 12px;
            ...
            ha-card.ContentCardRoom .box .wrapper .ha-tv-source {
                --mdc-icon-size: 12px;
            ...
            ha-card.ContentCardRoom .box .entities .wrapper, ha-card.ContentCardRoom .box .entities_top_right .wrapper{
                height: 17px;
                min-width: 17px;                
            }

            ha-card.ContentCardRoom .box .wrapper .sensor{
                margin-left: -5px;
            }
            ...
            ha-card.ContentCardRoom .box > img {
                display: block;
                height: 100%;
                width: 100%;
